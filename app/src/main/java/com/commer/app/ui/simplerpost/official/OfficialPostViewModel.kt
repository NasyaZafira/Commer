...
@HiltViewModel
class OfficialPostViewModel @Inject constructor(
    private val mainRepository: MainRepository
) : BaseViewModel() {

    val officialPostResponse = MutableLiveData<GetPostResponse>()
    suspend fun getOfficialPostFromServer(tags: String?) {
        mainRepository.getOfficialPost(
            ...
            officialPostResponse.postValue(it)
        }
    }
